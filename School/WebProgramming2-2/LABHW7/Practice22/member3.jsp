...
<body>
    <div align = "center">
       ...
       <form name = "form3" method = post action=Practice22.jsp>
       <table border = "1">
        ...
        <tr>
            ...
            <td class = "td2"><input type = "password" size = "15px" name = "Pwd"></td>
        </tr>
        ...
        <tr>
            <td class = "td1">이메일</td>
            <td class = "td2"><input type = "email" size = "38px" name = "email"></td>
        </tr>
